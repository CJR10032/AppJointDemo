...
/**
 * 创建者     CJR
 * 创建时间   2019/8/15 14:26
 * 描述       RecyclerView的BaseViewHolder
 */
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * 根据View的id获取相应的View, 如果SparseArray里没有, 就findViewById并存进SparseArray中
    ...
    /**
     * ImageView及其子类的setImageResource
     * @param viewId     View的id
